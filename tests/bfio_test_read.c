/*
 * Basic File IO (BFIO) library read testing program
 *
 ...
 */
int bfio_test_get_offset(
     libbfio_handle_t *handle,
     off64_t expected_offset,
     libcerror_error_t **error )
{
	static char *function = "bfio_test_get_offset";
