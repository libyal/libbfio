/*
 * Library file_range type test program
 *
...
#include "../libbfio/libbfio_file_range.h"
...
#define BFIO_TEST_FILE_RANGE_VERBOSE
 */

/* Tests the libbfio_file_range_initialize function
 * Returns 1 if successful or 0 if not
 */
int bfio_test_file_range_initialize(
     void )
{
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libbfio_file_range_initialize with malloc failing
		 */
...
/* Tests the libbfio_file_range_get_name_size function
 * Returns 1 if successful or 0 if not
 */
int bfio_test_file_range_get_name_size(
     libbfio_handle_t *handle )
{
	...
	/* Test regular cases
	 */
	result = libbfio_file_range_get_name_size(
	          handle,
	          &name_size,
	          &error );
...
/* Tests the libbfio_file_range_get_name function
 * Returns 1 if successful or 0 if not
 */
int bfio_test_file_range_get_name(
     libbfio_handle_t *handle )
{
	char name[ 256 ];
	...
	/* Test regular cases
	 */
	result = libbfio_file_range_get_name(
	          handle,
	          name,
	          256,
	          &error );
...
/* Tests the libbfio_file_range_set_name function
 * Returns 1 if successful or 0 if not
 */
int bfio_test_file_range_set_name(
     void )
{
	libbfio_handle_t *handle = NULL;
	libcerror_error_t *error = NULL;
...
/* Tests the libbfio_file_range_get_name_size_wide function
 * Returns 1 if successful or 0 if not
 */
int bfio_test_file_range_get_name_size_wide(
     libbfio_handle_t *handle )
{
	libcerror_error_t *error = NULL;
	...
	/* Test regular cases
	 */
	result = libbfio_file_range_get_name_size_wide(
	          handle,
	          &name_size_wide,
	          &error );
...
/* Tests the libbfio_file_range_get_name_wide function
 * Returns 1 if successful or 0 if not
 */
int bfio_test_file_range_get_name_wide(
     libbfio_handle_t *handle )
{
	wchar_t name[ 256 ];
	...
	/* Test regular cases
	 */
	result = libbfio_file_range_get_name_wide(
	          handle,
	          name,
	          256,
	          &error );
...
/* Tests the libbfio_file_range_set_name_wide function
 * Returns 1 if successful or 0 if not
 */
int bfio_test_file_range_set_name_wide(
     void )
{
	libbfio_handle_t *handle = NULL;
	libcerror_error_t *error = NULL;
...
#endif
{
...
#if defined( HAVE_DEBUG_OUTPUT ) && defined( BFIO_TEST_FILE_RANGE_VERBOSE )
	...
	BFIO_TEST_RUN(
	 ...
	 bfio_test_file_range_initialize );

	BFIO_TEST_RUN(
	 "libbfio_file_range_set_name",
	 bfio_test_file_range_set_name );

#if defined( HAVE_WIDE_CHARACTER_TYPE )

	BFIO_TEST_RUN(
	 "libbfio_file_range_set_name_wide",
	 bfio_test_file_range_set_name_wide );
	...
	if( source != NULL )
	{
		...
		BFIO_TEST_RUN_WITH_ARGS(
		 ...
		 bfio_test_file_range_get_name_size,
		 handle );

		BFIO_TEST_RUN_WITH_ARGS(
		 "libbfio_file_range_get_name",
		 bfio_test_file_range_get_name,
		 handle );
		...
		BFIO_TEST_RUN_WITH_ARGS(
		 ...
		 bfio_test_file_range_get_name_size_wide,
		 handle );

		BFIO_TEST_RUN_WITH_ARGS(
		 "libbfio_file_range_get_name_wide",
		 bfio_test_file_range_get_name_wide,
		 handle );
