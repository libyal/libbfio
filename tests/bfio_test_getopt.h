...
#if !defined( _BFIO_TEST_GETOPT_H )
#define _BFIO_TEST_GETOPT_H
...
#define bfio_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t bfio_test_getopt(
                  int argument_count,
...
#endif /* !defined( _BFIO_TEST_GETOPT_H ) */
