...
/* Define to make bfio_test_handle generate verbose output
...
#if defined( LIBBFIO_HAVE_BFIO )

		/* TODO add test for libbfio_handle_open_file_io_handle */

#endif /* defined( LIBBFIO_HAVE_BFIO ) */
