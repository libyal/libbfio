...
$LibraryTestsWithInput = "file file_io_handle file_range file_range_io_handle handle pool"
...
Function RunTest
{
	...
	$TestExecutable = "${TestToolDirectory}\bfio_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libbfio"
