...
LIBRARY_TESTS_WITH_INPUT="file file_io_handle file_range file_range_io_handle handle pool";
OPTION_SETS="";
...
run_test()
{
	...
	local TEST_EXECUTABLE="./bfio_test_${TEST_NAME}";
...
run_test_with_input()
{
	...
	local TEST_PROFILE_DIRECTORY=$(get_test_profile_directory "input" "libbfio");
