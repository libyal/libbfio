...
{
	static char *function = "libbfio_wide_split_string_initialize";
	...
	*split_string = memory_allocate_structure(
	...
	if( memory_set(
	     *split_string,
	     0,
	     sizeof( libbfio_wide_split_string_t ) ) == NULL )
	{
		liberror_error_set(
		 error,
		 LIBERROR_ERROR_DOMAIN_MEMORY,
...
int libbfio_wide_split_string_free(
     ...
     liberror_error_t **error )
{
	static char *function = "libbfio_wide_split_string_free";
...
int libbfio_wide_split_string_get_string(
     ...
     liberror_error_t **error )
{
	static char *function = "libbfio_wide_split_string_get_string";
...
int libbfio_wide_split_string_get_number_of_segments(
     ...
     liberror_error_t **error )
{
	static char *function = "libbfio_wide_split_string_get_number_of_segments";
...
int libbfio_wide_split_string_get_segment_by_index(
     ...
     liberror_error_t **error )
{
	static char *function = "libbfio_wide_split_string_get_segment_by_index";
...
int libbfio_wide_split_string_set_segment_by_index(
     ...
     liberror_error_t **error )
{
	static char *function        = "libbfio_wide_split_string_set_segment_by_index";
